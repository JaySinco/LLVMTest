...
const static char *kDataRoot = "./resources/deep/mnist-data";

// The batch size for training.
const static int64_t kTrainBatchSize = 64;

// The batch size for testing.
const static int64_t kTestBatchSize = 1000;

// The number of epochs to train.
const static int64_t kNumberOfEpochs = 10;

// After how many batches to log a new update with the loss value.
const static int64_t kLogInterval = 10;
